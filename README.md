...
![Version: 0.33.1-bb.1](https://img.shields.io/badge/Version-0.33.1--bb.1-informational?style=flat-square) ![AppVersion: 14.3.1](https://img.shields.io/badge/AppVersion-14.3.1-informational?style=flat-square)
...
|-----|------|---------|-------------|
| image | string | `"registry1.dso.mil/ironbank/gitlab/gitlab-runner/gitlab-runner:v14.3.1"` |  |
