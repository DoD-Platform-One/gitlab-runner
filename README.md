...
![Version: 0.38.1-bb.1](https://img.shields.io/badge/Version-0.38.1--bb.1-informational?style=flat-square) ![AppVersion: 14.8.2](https://img.shields.io/badge/AppVersion-14.8.2-informational?style=flat-square)
...
|-----|------|---------|-------------|
| image | string | `"registry1.dso.mil/ironbank/gitlab/gitlab-runner/gitlab-runner:v14.8.2"` |  |
